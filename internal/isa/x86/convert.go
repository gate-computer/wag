...
func truncFloatToUnsignedI64(f *gen.Func, target reg.R, sourceType wa.Type, source reg.R) {
	...
	truncMaskAddr := rodata.MaskAddr(CommonRODataAddr, rodata.MaskTruncBase, sourceType)
	...
	in.MOV.RegMemDisp(&f.Text, wa.I64, RegScratch, in.BaseText, CommonRODataAddr+rodata.Mask80Offset64)

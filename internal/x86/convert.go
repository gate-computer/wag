...
func opWrap(f *gen.Func, resultType abi.Type, source values.Operand) values.Operand {
...
func opTruncFloatToUnsignedI64(f *gen.Func, sourceType abi.Type, inputReg regs.R) {
	...
	mov.opFromAddr(&f.Text, abi.I64, RegScratch, 0, NoIndex, roDataAddr+gen.ROMask80Addr64)

...
var opcodeImpls = [256]opImpl{
	...
	0x26:                    {badGen, 0},
	0x27:                    {badGen, 0},
	OpcodeI32Load:           {genLoadOp, opInfo(abi.I32) | (opInfo(prop.I32Load) << 16)},
	OpcodeI64Load:           {genLoadOp, opInfo(abi.I64) | (opInfo(prop.I64Load) << 16)},
	OpcodeF32Load:           {genLoadOp, opInfo(abi.F32) | (opInfo(prop.F32Load) << 16)},
	OpcodeF64Load:           {genLoadOp, opInfo(abi.F64) | (opInfo(prop.F64Load) << 16)},
	OpcodeI32Load8S:         {genLoadOp, opInfo(abi.I32) | (opInfo(prop.IntLoad8S) << 16)},
	OpcodeI32Load8U:         {genLoadOp, opInfo(abi.I32) | (opInfo(prop.IntLoad8U) << 16)},
	OpcodeI32Load16S:        {genLoadOp, opInfo(abi.I32) | (opInfo(prop.IntLoad16S) << 16)},
	OpcodeI32Load16U:        {genLoadOp, opInfo(abi.I32) | (opInfo(prop.IntLoad16U) << 16)},
	OpcodeI64Load8S:         {genLoadOp, opInfo(abi.I64) | (opInfo(prop.IntLoad8S) << 16)},
	OpcodeI64Load8U:         {genLoadOp, opInfo(abi.I64) | (opInfo(prop.IntLoad8U) << 16)},
	OpcodeI64Load16S:        {genLoadOp, opInfo(abi.I64) | (opInfo(prop.IntLoad16S) << 16)},
	OpcodeI64Load16U:        {genLoadOp, opInfo(abi.I64) | (opInfo(prop.IntLoad16U) << 16)},
	OpcodeI64Load32S:        {genLoadOp, opInfo(abi.I64) | (opInfo(prop.IntLoad32S) << 16)},
	OpcodeI64Load32U:        {genLoadOp, opInfo(abi.I64) | (opInfo(prop.IntLoad32U) << 16)},
	OpcodeI32Store:          {genStoreOp, opInfo(abi.I32) | (opInfo(prop.I32Store) << 16)},
	OpcodeI64Store:          {genStoreOp, opInfo(abi.I64) | (opInfo(prop.I64Store) << 16)},
	OpcodeF32Store:          {genStoreOp, opInfo(abi.F32) | (opInfo(prop.F32Store) << 16)},
	OpcodeF64Store:          {genStoreOp, opInfo(abi.F64) | (opInfo(prop.F64Store) << 16)},
	OpcodeI32Store8:         {genStoreOp, opInfo(abi.I32) | (opInfo(prop.IntStore8) << 16)},
	OpcodeI32Store16:        {genStoreOp, opInfo(abi.I32) | (opInfo(prop.IntStore16) << 16)},
	OpcodeI64Store8:         {genStoreOp, opInfo(abi.I64) | (opInfo(prop.IntStore8) << 16)},
	OpcodeI64Store16:        {genStoreOp, opInfo(abi.I64) | (opInfo(prop.IntStore16) << 16)},
	OpcodeI64Store32:        {genStoreOp, opInfo(abi.I64) | (opInfo(prop.IntStore32) << 16)},
	...
	OpcodeI32Eqz:            {genUnaryConditionOp, opInfo(abi.I32) | (opInfo(prop.IntEqz) << 16)},
	OpcodeI32Eq:             {genBinaryConditionCommuteOp, opInfo(abi.I32) | (opInfo(prop.IntEq) << 16)},
	OpcodeI32Ne:             {genBinaryConditionCommuteOp, opInfo(abi.I32) | (opInfo(prop.IntNe) << 16)},
	OpcodeI32LtS:            {genBinaryConditionOp, opInfo(abi.I32) | (opInfo(prop.IntLtS) << 16)},
	OpcodeI32LtU:            {genBinaryConditionOp, opInfo(abi.I32) | (opInfo(prop.IntLtU) << 16)},
	OpcodeI32GtS:            {genBinaryConditionOp, opInfo(abi.I32) | (opInfo(prop.IntGtS) << 16)},
	OpcodeI32GtU:            {genBinaryConditionOp, opInfo(abi.I32) | (opInfo(prop.IntGtU) << 16)},
	OpcodeI32LeS:            {genBinaryConditionOp, opInfo(abi.I32) | (opInfo(prop.IntLeS) << 16)},
	OpcodeI32LeU:            {genBinaryConditionOp, opInfo(abi.I32) | (opInfo(prop.IntLeU) << 16)},
	OpcodeI32GeS:            {genBinaryConditionOp, opInfo(abi.I32) | (opInfo(prop.IntGeS) << 16)},
	OpcodeI32GeU:            {genBinaryConditionOp, opInfo(abi.I32) | (opInfo(prop.IntGeU) << 16)},
	OpcodeI64Eqz:            {genUnaryConditionOp, opInfo(abi.I64) | (opInfo(prop.IntEqz) << 16)},
	OpcodeI64Eq:             {genBinaryConditionCommuteOp, opInfo(abi.I64) | (opInfo(prop.IntEq) << 16)},
	OpcodeI64Ne:             {genBinaryConditionCommuteOp, opInfo(abi.I64) | (opInfo(prop.IntNe) << 16)},
	OpcodeI64LtS:            {genBinaryConditionOp, opInfo(abi.I64) | (opInfo(prop.IntLtS) << 16)},
	OpcodeI64LtU:            {genBinaryConditionOp, opInfo(abi.I64) | (opInfo(prop.IntLtU) << 16)},
	OpcodeI64GtS:            {genBinaryConditionOp, opInfo(abi.I64) | (opInfo(prop.IntGtS) << 16)},
	OpcodeI64GtU:            {genBinaryConditionOp, opInfo(abi.I64) | (opInfo(prop.IntGtU) << 16)},
	OpcodeI64LeS:            {genBinaryConditionOp, opInfo(abi.I64) | (opInfo(prop.IntLeS) << 16)},
	OpcodeI64LeU:            {genBinaryConditionOp, opInfo(abi.I64) | (opInfo(prop.IntLeU) << 16)},
	OpcodeI64GeS:            {genBinaryConditionOp, opInfo(abi.I64) | (opInfo(prop.IntGeS) << 16)},
	OpcodeI64GeU:            {genBinaryConditionOp, opInfo(abi.I64) | (opInfo(prop.IntGeU) << 16)},
	OpcodeF32Eq:             {genBinaryConditionCommuteOp, opInfo(abi.F32) | (opInfo(prop.FloatEq) << 16)},
	OpcodeF32Ne:             {genBinaryConditionCommuteOp, opInfo(abi.F32) | (opInfo(prop.FloatNe) << 16)},
	OpcodeF32Lt:             {genBinaryConditionOp, opInfo(abi.F32) | (opInfo(prop.FloatLt) << 16)},
	OpcodeF32Gt:             {genBinaryConditionOp, opInfo(abi.F32) | (opInfo(prop.FloatGt) << 16)},
	OpcodeF32Le:             {genBinaryConditionOp, opInfo(abi.F32) | (opInfo(prop.FloatLe) << 16)},
	OpcodeF32Ge:             {genBinaryConditionOp, opInfo(abi.F32) | (opInfo(prop.FloatGe) << 16)},
	OpcodeF64Eq:             {genBinaryConditionCommuteOp, opInfo(abi.F64) | (opInfo(prop.FloatEq) << 16)},
	OpcodeF64Ne:             {genBinaryConditionCommuteOp, opInfo(abi.F64) | (opInfo(prop.FloatNe) << 16)},
	OpcodeF64Lt:             {genBinaryConditionOp, opInfo(abi.F64) | (opInfo(prop.FloatLt) << 16)},
	OpcodeF64Gt:             {genBinaryConditionOp, opInfo(abi.F64) | (opInfo(prop.FloatGt) << 16)},
	OpcodeF64Le:             {genBinaryConditionOp, opInfo(abi.F64) | (opInfo(prop.FloatLe) << 16)},
	OpcodeF64Ge:             {genBinaryConditionOp, opInfo(abi.F64) | (opInfo(prop.FloatGe) << 16)},
	OpcodeI32Clz:            {genUnaryOp, opInfo(abi.I32) | (opInfo(prop.IntClz) << 16)},
	OpcodeI32Ctz:            {genUnaryOp, opInfo(abi.I32) | (opInfo(prop.IntCtz) << 16)},
	OpcodeI32Popcnt:         {genUnaryOp, opInfo(abi.I32) | (opInfo(prop.IntPopcnt) << 16)},
	OpcodeI32Add:            {genBinaryCommuteOp, opInfo(abi.I32) | (opInfo(prop.IntAdd) << 16)},
	OpcodeI32Sub:            {genBinaryOp, opInfo(abi.I32) | (opInfo(prop.IntSub) << 16)},
	OpcodeI32Mul:            {genBinaryCommuteOp, opInfo(abi.I32) | (opInfo(prop.IntMul) << 16)},
	OpcodeI32DivS:           {genBinaryOp, opInfo(abi.I32) | (opInfo(prop.IntDivS) << 16)},
	OpcodeI32DivU:           {genBinaryOp, opInfo(abi.I32) | (opInfo(prop.IntDivU) << 16)},
	OpcodeI32RemS:           {genBinaryOp, opInfo(abi.I32) | (opInfo(prop.IntRemS) << 16)},
	OpcodeI32RemU:           {genBinaryOp, opInfo(abi.I32) | (opInfo(prop.IntRemU) << 16)},
	OpcodeI32And:            {genBinaryCommuteOp, opInfo(abi.I32) | (opInfo(prop.IntAnd) << 16)},
	OpcodeI32Or:             {genBinaryCommuteOp, opInfo(abi.I32) | (opInfo(prop.IntOr) << 16)},
	OpcodeI32Xor:            {genBinaryCommuteOp, opInfo(abi.I32) | (opInfo(prop.IntXor) << 16)},
	OpcodeI32Shl:            {genBinaryOp, opInfo(abi.I32) | (opInfo(prop.IntShl) << 16)},
	OpcodeI32ShrS:           {genBinaryOp, opInfo(abi.I32) | (opInfo(prop.IntShrS) << 16)},
	OpcodeI32ShrU:           {genBinaryOp, opInfo(abi.I32) | (opInfo(prop.IntShrU) << 16)},
	OpcodeI32Rotl:           {genBinaryOp, opInfo(abi.I32) | (opInfo(prop.IntRotl) << 16)},
	OpcodeI32Rotr:           {genBinaryOp, opInfo(abi.I32) | (opInfo(prop.IntRotr) << 16)},
	OpcodeI64Clz:            {genUnaryOp, opInfo(abi.I64) | (opInfo(prop.IntClz) << 16)},
	OpcodeI64Ctz:            {genUnaryOp, opInfo(abi.I64) | (opInfo(prop.IntCtz) << 16)},
	OpcodeI64Popcnt:         {genUnaryOp, opInfo(abi.I64) | (opInfo(prop.IntPopcnt) << 16)},
	OpcodeI64Add:            {genBinaryCommuteOp, opInfo(abi.I64) | (opInfo(prop.IntAdd) << 16)},
	OpcodeI64Sub:            {genBinaryOp, opInfo(abi.I64) | (opInfo(prop.IntSub) << 16)},
	OpcodeI64Mul:            {genBinaryCommuteOp, opInfo(abi.I64) | (opInfo(prop.IntMul) << 16)},
	OpcodeI64DivS:           {genBinaryOp, opInfo(abi.I64) | (opInfo(prop.IntDivS) << 16)},
	OpcodeI64DivU:           {genBinaryOp, opInfo(abi.I64) | (opInfo(prop.IntDivU) << 16)},
	OpcodeI64RemS:           {genBinaryOp, opInfo(abi.I64) | (opInfo(prop.IntRemS) << 16)},
	OpcodeI64RemU:           {genBinaryOp, opInfo(abi.I64) | (opInfo(prop.IntRemU) << 16)},
	OpcodeI64And:            {genBinaryCommuteOp, opInfo(abi.I64) | (opInfo(prop.IntAnd) << 16)},
	OpcodeI64Or:             {genBinaryCommuteOp, opInfo(abi.I64) | (opInfo(prop.IntOr) << 16)},
	OpcodeI64Xor:            {genBinaryCommuteOp, opInfo(abi.I64) | (opInfo(prop.IntXor) << 16)},
	OpcodeI64Shl:            {genBinaryOp, opInfo(abi.I64) | (opInfo(prop.IntShl) << 16)},
	OpcodeI64ShrS:           {genBinaryOp, opInfo(abi.I64) | (opInfo(prop.IntShrS) << 16)},
	OpcodeI64ShrU:           {genBinaryOp, opInfo(abi.I64) | (opInfo(prop.IntShrU) << 16)},
	OpcodeI64Rotl:           {genBinaryOp, opInfo(abi.I64) | (opInfo(prop.IntRotl) << 16)},
	OpcodeI64Rotr:           {genBinaryOp, opInfo(abi.I64) | (opInfo(prop.IntRotr) << 16)},
	OpcodeF32Abs:            {genUnaryOp, opInfo(abi.F32) | (opInfo(prop.FloatAbs) << 16)},
	OpcodeF32Neg:            {genUnaryOp, opInfo(abi.F32) | (opInfo(prop.FloatNeg) << 16)},
	OpcodeF32Ceil:           {genUnaryOp, opInfo(abi.F32) | (opInfo(prop.FloatCeil) << 16)},
	OpcodeF32Floor:          {genUnaryOp, opInfo(abi.F32) | (opInfo(prop.FloatFloor) << 16)},
	OpcodeF32Trunc:          {genUnaryOp, opInfo(abi.F32) | (opInfo(prop.FloatTrunc) << 16)},
	OpcodeF32Nearest:        {genUnaryOp, opInfo(abi.F32) | (opInfo(prop.FloatNearest) << 16)},
	OpcodeF32Sqrt:           {genUnaryOp, opInfo(abi.F32) | (opInfo(prop.FloatSqrt) << 16)},
	OpcodeF32Add:            {genBinaryCommuteOp, opInfo(abi.F32) | (opInfo(prop.FloatAdd) << 16)},
	OpcodeF32Sub:            {genBinaryOp, opInfo(abi.F32) | (opInfo(prop.FloatSub) << 16)},
	OpcodeF32Mul:            {genBinaryCommuteOp, opInfo(abi.F32) | (opInfo(prop.FloatMul) << 16)},
	OpcodeF32Div:            {genBinaryOp, opInfo(abi.F32) | (opInfo(prop.FloatDiv) << 16)},
	OpcodeF32Min:            {genBinaryCommuteOp, opInfo(abi.F32) | (opInfo(prop.FloatMin) << 16)},
	OpcodeF32Max:            {genBinaryCommuteOp, opInfo(abi.F32) | (opInfo(prop.FloatMax) << 16)},
	OpcodeF32Copysign:       {genBinaryOp, opInfo(abi.F32) | (opInfo(prop.FloatCopysign) << 16)},
	OpcodeF64Abs:            {genUnaryOp, opInfo(abi.F64) | (opInfo(prop.FloatAbs) << 16)},
	OpcodeF64Neg:            {genUnaryOp, opInfo(abi.F64) | (opInfo(prop.FloatNeg) << 16)},
	OpcodeF64Ceil:           {genUnaryOp, opInfo(abi.F64) | (opInfo(prop.FloatCeil) << 16)},
	OpcodeF64Floor:          {genUnaryOp, opInfo(abi.F64) | (opInfo(prop.FloatFloor) << 16)},
	OpcodeF64Trunc:          {genUnaryOp, opInfo(abi.F64) | (opInfo(prop.FloatTrunc) << 16)},
	OpcodeF64Nearest:        {genUnaryOp, opInfo(abi.F64) | (opInfo(prop.FloatNearest) << 16)},
	OpcodeF64Sqrt:           {genUnaryOp, opInfo(abi.F64) | (opInfo(prop.FloatSqrt) << 16)},
	OpcodeF64Add:            {genBinaryCommuteOp, opInfo(abi.F64) | (opInfo(prop.FloatAdd) << 16)},
	OpcodeF64Sub:            {genBinaryOp, opInfo(abi.F64) | (opInfo(prop.FloatSub) << 16)},
	OpcodeF64Mul:            {genBinaryCommuteOp, opInfo(abi.F64) | (opInfo(prop.FloatMul) << 16)},
	OpcodeF64Div:            {genBinaryOp, opInfo(abi.F64) | (opInfo(prop.FloatDiv) << 16)},
	OpcodeF64Min:            {genBinaryCommuteOp, opInfo(abi.F64) | (opInfo(prop.FloatMin) << 16)},
	OpcodeF64Max:            {genBinaryCommuteOp, opInfo(abi.F64) | (opInfo(prop.FloatMax) << 16)},
	OpcodeF64Copysign:       {genBinaryOp, opInfo(abi.F64) | (opInfo(prop.FloatCopysign) << 16)},
	OpcodeI32WrapI64:        {genConversionOp, opInfo(abi.I32) | (opInfo(abi.I64) << 8) | (opInfo(prop.Wrap) << 16)},
	OpcodeI32TruncSF32:      {genConversionOp, opInfo(abi.I32) | (opInfo(abi.F32) << 8) | (opInfo(prop.TruncS) << 16)},
	OpcodeI32TruncUF32:      {genConversionOp, opInfo(abi.I32) | (opInfo(abi.F32) << 8) | (opInfo(prop.TruncU) << 16)},
	OpcodeI32TruncSF64:      {genConversionOp, opInfo(abi.I32) | (opInfo(abi.F64) << 8) | (opInfo(prop.TruncS) << 16)},
	OpcodeI32TruncUF64:      {genConversionOp, opInfo(abi.I32) | (opInfo(abi.F64) << 8) | (opInfo(prop.TruncU) << 16)},
	OpcodeI64ExtendSI32:     {genConversionOp, opInfo(abi.I64) | (opInfo(abi.I32) << 8) | (opInfo(prop.ExtendS) << 16)},
	OpcodeI64ExtendUI32:     {genConversionOp, opInfo(abi.I64) | (opInfo(abi.I32) << 8) | (opInfo(prop.ExtendU) << 16)},
	OpcodeI64TruncSF32:      {genConversionOp, opInfo(abi.I64) | (opInfo(abi.F32) << 8) | (opInfo(prop.TruncS) << 16)},
	OpcodeI64TruncUF32:      {genConversionOp, opInfo(abi.I64) | (opInfo(abi.F32) << 8) | (opInfo(prop.TruncU) << 16)},
	OpcodeI64TruncSF64:      {genConversionOp, opInfo(abi.I64) | (opInfo(abi.F64) << 8) | (opInfo(prop.TruncS) << 16)},
	OpcodeI64TruncUF64:      {genConversionOp, opInfo(abi.I64) | (opInfo(abi.F64) << 8) | (opInfo(prop.TruncU) << 16)},
	OpcodeF32ConvertSI32:    {genConversionOp, opInfo(abi.F32) | (opInfo(abi.I32) << 8) | (opInfo(prop.ConvertS) << 16)},
	OpcodeF32ConvertUI32:    {genConversionOp, opInfo(abi.F32) | (opInfo(abi.I32) << 8) | (opInfo(prop.ConvertU) << 16)},
	OpcodeF32ConvertSI64:    {genConversionOp, opInfo(abi.F32) | (opInfo(abi.I64) << 8) | (opInfo(prop.ConvertS) << 16)},
	OpcodeF32ConvertUI64:    {genConversionOp, opInfo(abi.F32) | (opInfo(abi.I64) << 8) | (opInfo(prop.ConvertU) << 16)},
	OpcodeF32DemoteF64:      {genConversionOp, opInfo(abi.F32) | (opInfo(abi.F64) << 8) | (opInfo(prop.Demote) << 16)},
	OpcodeF64ConvertSI32:    {genConversionOp, opInfo(abi.F64) | (opInfo(abi.I32) << 8) | (opInfo(prop.ConvertS) << 16)},
	OpcodeF64ConvertUI32:    {genConversionOp, opInfo(abi.F64) | (opInfo(abi.I32) << 8) | (opInfo(prop.ConvertU) << 16)},
	OpcodeF64ConvertSI64:    {genConversionOp, opInfo(abi.F64) | (opInfo(abi.I64) << 8) | (opInfo(prop.ConvertS) << 16)},
	OpcodeF64ConvertUI64:    {genConversionOp, opInfo(abi.F64) | (opInfo(abi.I64) << 8) | (opInfo(prop.ConvertU) << 16)},
	OpcodeF64PromoteF32:     {genConversionOp, opInfo(abi.F64) | (opInfo(abi.F32) << 8) | (opInfo(prop.Promote) << 16)},
	OpcodeI32ReinterpretF32: {genConversionOp, opInfo(abi.I32) | (opInfo(abi.F32) << 8) | (opInfo(prop.Reinterpret) << 16)},
	OpcodeI64ReinterpretF64: {genConversionOp, opInfo(abi.I64) | (opInfo(abi.F64) << 8) | (opInfo(prop.Reinterpret) << 16)},
	OpcodeF32ReinterpretI32: {genConversionOp, opInfo(abi.F32) | (opInfo(abi.I32) << 8) | (opInfo(prop.Reinterpret) << 16)},
	OpcodeF64ReinterpretI64: {genConversionOp, opInfo(abi.F64) | (opInfo(abi.I64) << 8) | (opInfo(prop.Reinterpret) << 16)},
	0xc0:                    {badGen, 0},
	0xc1:                    {badGen, 0},
	0xc2:                    {badGen, 0},
	0xc3:                    {badGen, 0},

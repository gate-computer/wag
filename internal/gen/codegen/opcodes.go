...
var opcodeImpls = [256]opImpl{
	...
	0x26:                    {badGen, 0},
	0x27:                    {badGen, 0},
	OpcodeI32Load:           {genLoad, opInfo(wa.I32) | (opInfo(prop.I32Load) << 16)},
	OpcodeI64Load:           {genLoad, opInfo(wa.I64) | (opInfo(prop.I64Load) << 16)},
	OpcodeF32Load:           {genLoad, opInfo(wa.F32) | (opInfo(prop.F32Load) << 16)},
	OpcodeF64Load:           {genLoad, opInfo(wa.F64) | (opInfo(prop.F64Load) << 16)},
	OpcodeI32Load8S:         {genLoad, opInfo(wa.I32) | (opInfo(prop.I32Load8S) << 16)},
	OpcodeI32Load8U:         {genLoad, opInfo(wa.I32) | (opInfo(prop.I32Load8U) << 16)},
	OpcodeI32Load16S:        {genLoad, opInfo(wa.I32) | (opInfo(prop.I32Load16S) << 16)},
	OpcodeI32Load16U:        {genLoad, opInfo(wa.I32) | (opInfo(prop.I32Load16U) << 16)},
	OpcodeI64Load8S:         {genLoad, opInfo(wa.I64) | (opInfo(prop.I64Load8S) << 16)},
	OpcodeI64Load8U:         {genLoad, opInfo(wa.I64) | (opInfo(prop.I64Load8U) << 16)},
	OpcodeI64Load16S:        {genLoad, opInfo(wa.I64) | (opInfo(prop.I64Load16S) << 16)},
	OpcodeI64Load16U:        {genLoad, opInfo(wa.I64) | (opInfo(prop.I64Load16U) << 16)},
	OpcodeI64Load32S:        {genLoad, opInfo(wa.I64) | (opInfo(prop.I64Load32S) << 16)},
	OpcodeI64Load32U:        {genLoad, opInfo(wa.I64) | (opInfo(prop.I64Load32U) << 16)},
	OpcodeI32Store:          {genStore, opInfo(wa.I32) | (opInfo(prop.I32Store) << 16)},
	OpcodeI64Store:          {genStore, opInfo(wa.I64) | (opInfo(prop.I64Store) << 16)},
	OpcodeF32Store:          {genStore, opInfo(wa.F32) | (opInfo(prop.F32Store) << 16)},
	OpcodeF64Store:          {genStore, opInfo(wa.F64) | (opInfo(prop.F64Store) << 16)},
	OpcodeI32Store8:         {genStore, opInfo(wa.I32) | (opInfo(prop.I32Store8) << 16)},
	OpcodeI32Store16:        {genStore, opInfo(wa.I32) | (opInfo(prop.I32Store16) << 16)},
	OpcodeI64Store8:         {genStore, opInfo(wa.I64) | (opInfo(prop.I64Store8) << 16)},
	OpcodeI64Store16:        {genStore, opInfo(wa.I64) | (opInfo(prop.I64Store16) << 16)},
	OpcodeI64Store32:        {genStore, opInfo(wa.I64) | (opInfo(prop.I64Store32) << 16)},
	OpcodeCurrentMemory:     {genCurrentMemory, 0},
	OpcodeGrowMemory:        {genGrowMemory, 0},
	OpcodeI32Const:          {genConstI32, opInfo(wa.I32)},
	OpcodeI64Const:          {genConstI64, opInfo(wa.I64)},
	OpcodeF32Const:          {genConstF32, opInfo(wa.F32)},
	OpcodeF64Const:          {genConstF64, opInfo(wa.F64)},
	OpcodeI32Eqz:            {genUnary, opInfo(wa.I32) | (opInfo(prop.IntEqz) << 16)},
	OpcodeI32Eq:             {genBinaryCommute, opInfo(wa.I32) | (opInfo(prop.IntEq) << 16)},
	OpcodeI32Ne:             {genBinaryCommute, opInfo(wa.I32) | (opInfo(prop.IntNe) << 16)},
	OpcodeI32LtS:            {genBinary, opInfo(wa.I32) | (opInfo(prop.IntLtS) << 16)},
	OpcodeI32LtU:            {genBinary, opInfo(wa.I32) | (opInfo(prop.IntLtU) << 16)},
	OpcodeI32GtS:            {genBinary, opInfo(wa.I32) | (opInfo(prop.IntGtS) << 16)},
	OpcodeI32GtU:            {genBinary, opInfo(wa.I32) | (opInfo(prop.IntGtU) << 16)},
	OpcodeI32LeS:            {genBinary, opInfo(wa.I32) | (opInfo(prop.IntLeS) << 16)},
	OpcodeI32LeU:            {genBinary, opInfo(wa.I32) | (opInfo(prop.IntLeU) << 16)},
	OpcodeI32GeS:            {genBinary, opInfo(wa.I32) | (opInfo(prop.IntGeS) << 16)},
	OpcodeI32GeU:            {genBinary, opInfo(wa.I32) | (opInfo(prop.IntGeU) << 16)},
	OpcodeI64Eqz:            {genUnary, opInfo(wa.I64) | (opInfo(prop.IntEqz) << 16)},
	OpcodeI64Eq:             {genBinaryCommute, opInfo(wa.I64) | (opInfo(prop.IntEq) << 16)},
	OpcodeI64Ne:             {genBinaryCommute, opInfo(wa.I64) | (opInfo(prop.IntNe) << 16)},
	OpcodeI64LtS:            {genBinary, opInfo(wa.I64) | (opInfo(prop.IntLtS) << 16)},
	OpcodeI64LtU:            {genBinary, opInfo(wa.I64) | (opInfo(prop.IntLtU) << 16)},
	OpcodeI64GtS:            {genBinary, opInfo(wa.I64) | (opInfo(prop.IntGtS) << 16)},
	OpcodeI64GtU:            {genBinary, opInfo(wa.I64) | (opInfo(prop.IntGtU) << 16)},
	OpcodeI64LeS:            {genBinary, opInfo(wa.I64) | (opInfo(prop.IntLeS) << 16)},
	OpcodeI64LeU:            {genBinary, opInfo(wa.I64) | (opInfo(prop.IntLeU) << 16)},
	OpcodeI64GeS:            {genBinary, opInfo(wa.I64) | (opInfo(prop.IntGeS) << 16)},
	OpcodeI64GeU:            {genBinary, opInfo(wa.I64) | (opInfo(prop.IntGeU) << 16)},
	OpcodeF32Eq:             {genBinaryCommute, opInfo(wa.F32) | (opInfo(prop.FloatEq) << 16)},
	OpcodeF32Ne:             {genBinaryCommute, opInfo(wa.F32) | (opInfo(prop.FloatNe) << 16)},
	OpcodeF32Lt:             {genBinary, opInfo(wa.F32) | (opInfo(prop.FloatLt) << 16)},
	OpcodeF32Gt:             {genBinary, opInfo(wa.F32) | (opInfo(prop.FloatGt) << 16)},
	OpcodeF32Le:             {genBinary, opInfo(wa.F32) | (opInfo(prop.FloatLe) << 16)},
	OpcodeF32Ge:             {genBinary, opInfo(wa.F32) | (opInfo(prop.FloatGe) << 16)},
	OpcodeF64Eq:             {genBinaryCommute, opInfo(wa.F64) | (opInfo(prop.FloatEq) << 16)},
	OpcodeF64Ne:             {genBinaryCommute, opInfo(wa.F64) | (opInfo(prop.FloatNe) << 16)},
	OpcodeF64Lt:             {genBinary, opInfo(wa.F64) | (opInfo(prop.FloatLt) << 16)},
	OpcodeF64Gt:             {genBinary, opInfo(wa.F64) | (opInfo(prop.FloatGt) << 16)},
	OpcodeF64Le:             {genBinary, opInfo(wa.F64) | (opInfo(prop.FloatLe) << 16)},
	OpcodeF64Ge:             {genBinary, opInfo(wa.F64) | (opInfo(prop.FloatGe) << 16)},
	OpcodeI32Clz:            {genUnary, opInfo(wa.I32) | (opInfo(prop.IntClz) << 16)},
	OpcodeI32Ctz:            {genUnary, opInfo(wa.I32) | (opInfo(prop.IntCtz) << 16)},
	OpcodeI32Popcnt:         {genUnary, opInfo(wa.I32) | (opInfo(prop.IntPopcnt) << 16)},
	OpcodeI32Add:            {genBinaryCommute, opInfo(wa.I32) | (opInfo(prop.IntAdd) << 16)},
	OpcodeI32Sub:            {genBinary, opInfo(wa.I32) | (opInfo(prop.IntSub) << 16)},
	OpcodeI32Mul:            {genBinaryCommute, opInfo(wa.I32) | (opInfo(prop.IntMul) << 16)},
	OpcodeI32DivS:           {genBinary, opInfo(wa.I32) | (opInfo(prop.IntDivS) << 16)},
	OpcodeI32DivU:           {genBinary, opInfo(wa.I32) | (opInfo(prop.IntDivU) << 16)},
	OpcodeI32RemS:           {genBinary, opInfo(wa.I32) | (opInfo(prop.IntRemS) << 16)},
	OpcodeI32RemU:           {genBinary, opInfo(wa.I32) | (opInfo(prop.IntRemU) << 16)},
	OpcodeI32And:            {genBinaryCommute, opInfo(wa.I32) | (opInfo(prop.IntAnd) << 16)},
	OpcodeI32Or:             {genBinaryCommute, opInfo(wa.I32) | (opInfo(prop.IntOr) << 16)},
	OpcodeI32Xor:            {genBinaryCommute, opInfo(wa.I32) | (opInfo(prop.IntXor) << 16)},
	OpcodeI32Shl:            {genBinary, opInfo(wa.I32) | (opInfo(prop.IntShl) << 16)},
	OpcodeI32ShrS:           {genBinary, opInfo(wa.I32) | (opInfo(prop.IntShrS) << 16)},
	OpcodeI32ShrU:           {genBinary, opInfo(wa.I32) | (opInfo(prop.IntShrU) << 16)},
	OpcodeI32Rotl:           {genBinary, opInfo(wa.I32) | (opInfo(prop.IntRotl) << 16)},
	OpcodeI32Rotr:           {genBinary, opInfo(wa.I32) | (opInfo(prop.IntRotr) << 16)},
	OpcodeI64Clz:            {genUnary, opInfo(wa.I64) | (opInfo(prop.IntClz) << 16)},
	OpcodeI64Ctz:            {genUnary, opInfo(wa.I64) | (opInfo(prop.IntCtz) << 16)},
	OpcodeI64Popcnt:         {genUnary, opInfo(wa.I64) | (opInfo(prop.IntPopcnt) << 16)},
	OpcodeI64Add:            {genBinaryCommute, opInfo(wa.I64) | (opInfo(prop.IntAdd) << 16)},
	OpcodeI64Sub:            {genBinary, opInfo(wa.I64) | (opInfo(prop.IntSub) << 16)},
	OpcodeI64Mul:            {genBinaryCommute, opInfo(wa.I64) | (opInfo(prop.IntMul) << 16)},
	OpcodeI64DivS:           {genBinary, opInfo(wa.I64) | (opInfo(prop.IntDivS) << 16)},
	OpcodeI64DivU:           {genBinary, opInfo(wa.I64) | (opInfo(prop.IntDivU) << 16)},
	OpcodeI64RemS:           {genBinary, opInfo(wa.I64) | (opInfo(prop.IntRemS) << 16)},
	OpcodeI64RemU:           {genBinary, opInfo(wa.I64) | (opInfo(prop.IntRemU) << 16)},
	OpcodeI64And:            {genBinaryCommute, opInfo(wa.I64) | (opInfo(prop.IntAnd) << 16)},
	OpcodeI64Or:             {genBinaryCommute, opInfo(wa.I64) | (opInfo(prop.IntOr) << 16)},
	OpcodeI64Xor:            {genBinaryCommute, opInfo(wa.I64) | (opInfo(prop.IntXor) << 16)},
	OpcodeI64Shl:            {genBinary, opInfo(wa.I64) | (opInfo(prop.IntShl) << 16)},
	OpcodeI64ShrS:           {genBinary, opInfo(wa.I64) | (opInfo(prop.IntShrS) << 16)},
	OpcodeI64ShrU:           {genBinary, opInfo(wa.I64) | (opInfo(prop.IntShrU) << 16)},
	OpcodeI64Rotl:           {genBinary, opInfo(wa.I64) | (opInfo(prop.IntRotl) << 16)},
	OpcodeI64Rotr:           {genBinary, opInfo(wa.I64) | (opInfo(prop.IntRotr) << 16)},
	OpcodeF32Abs:            {genUnary, opInfo(wa.F32) | (opInfo(prop.FloatAbs) << 16)},
	OpcodeF32Neg:            {genUnary, opInfo(wa.F32) | (opInfo(prop.FloatNeg) << 16)},
	OpcodeF32Ceil:           {genUnary, opInfo(wa.F32) | (opInfo(prop.FloatCeil) << 16)},
	OpcodeF32Floor:          {genUnary, opInfo(wa.F32) | (opInfo(prop.FloatFloor) << 16)},
	OpcodeF32Trunc:          {genUnary, opInfo(wa.F32) | (opInfo(prop.FloatTrunc) << 16)},
	OpcodeF32Nearest:        {genUnary, opInfo(wa.F32) | (opInfo(prop.FloatNearest) << 16)},
	OpcodeF32Sqrt:           {genUnary, opInfo(wa.F32) | (opInfo(prop.FloatSqrt) << 16)},
	OpcodeF32Add:            {genBinaryCommute, opInfo(wa.F32) | (opInfo(prop.FloatAdd) << 16)},
	OpcodeF32Sub:            {genBinary, opInfo(wa.F32) | (opInfo(prop.FloatSub) << 16)},
	OpcodeF32Mul:            {genBinaryCommute, opInfo(wa.F32) | (opInfo(prop.FloatMul) << 16)},
	OpcodeF32Div:            {genBinary, opInfo(wa.F32) | (opInfo(prop.FloatDiv) << 16)},
	OpcodeF32Min:            {genBinaryCommute, opInfo(wa.F32) | (opInfo(prop.FloatMin) << 16)},
	OpcodeF32Max:            {genBinaryCommute, opInfo(wa.F32) | (opInfo(prop.FloatMax) << 16)},
	OpcodeF32Copysign:       {genBinary, opInfo(wa.F32) | (opInfo(prop.FloatCopysign) << 16)},
	OpcodeF64Abs:            {genUnary, opInfo(wa.F64) | (opInfo(prop.FloatAbs) << 16)},
	OpcodeF64Neg:            {genUnary, opInfo(wa.F64) | (opInfo(prop.FloatNeg) << 16)},
	OpcodeF64Ceil:           {genUnary, opInfo(wa.F64) | (opInfo(prop.FloatCeil) << 16)},
	OpcodeF64Floor:          {genUnary, opInfo(wa.F64) | (opInfo(prop.FloatFloor) << 16)},
	OpcodeF64Trunc:          {genUnary, opInfo(wa.F64) | (opInfo(prop.FloatTrunc) << 16)},
	OpcodeF64Nearest:        {genUnary, opInfo(wa.F64) | (opInfo(prop.FloatNearest) << 16)},
	OpcodeF64Sqrt:           {genUnary, opInfo(wa.F64) | (opInfo(prop.FloatSqrt) << 16)},
	OpcodeF64Add:            {genBinaryCommute, opInfo(wa.F64) | (opInfo(prop.FloatAdd) << 16)},
	OpcodeF64Sub:            {genBinary, opInfo(wa.F64) | (opInfo(prop.FloatSub) << 16)},
	OpcodeF64Mul:            {genBinaryCommute, opInfo(wa.F64) | (opInfo(prop.FloatMul) << 16)},
	OpcodeF64Div:            {genBinary, opInfo(wa.F64) | (opInfo(prop.FloatDiv) << 16)},
	OpcodeF64Min:            {genBinaryCommute, opInfo(wa.F64) | (opInfo(prop.FloatMin) << 16)},
	OpcodeF64Max:            {genBinaryCommute, opInfo(wa.F64) | (opInfo(prop.FloatMax) << 16)},
	OpcodeF64Copysign:       {genBinary, opInfo(wa.F64) | (opInfo(prop.FloatCopysign) << 16)},
	OpcodeI32WrapI64:        {genWrap, 0},
	OpcodeI32TruncSF32:      {genConvert, opInfo(wa.I32) | (opInfo(wa.F32) << 8) | (opInfo(prop.TruncS) << 16)},
	OpcodeI32TruncUF32:      {genConvert, opInfo(wa.I32) | (opInfo(wa.F32) << 8) | (opInfo(prop.TruncU) << 16)},
	OpcodeI32TruncSF64:      {genConvert, opInfo(wa.I32) | (opInfo(wa.F64) << 8) | (opInfo(prop.TruncS) << 16)},
	OpcodeI32TruncUF64:      {genConvert, opInfo(wa.I32) | (opInfo(wa.F64) << 8) | (opInfo(prop.TruncU) << 16)},
	OpcodeI64ExtendSI32:     {genConvert, opInfo(wa.I64) | (opInfo(wa.I32) << 8) | (opInfo(prop.ExtendS) << 16)},
	OpcodeI64ExtendUI32:     {genConvert, opInfo(wa.I64) | (opInfo(wa.I32) << 8) | (opInfo(prop.ExtendU) << 16)},
	OpcodeI64TruncSF32:      {genConvert, opInfo(wa.I64) | (opInfo(wa.F32) << 8) | (opInfo(prop.TruncS) << 16)},
	OpcodeI64TruncUF32:      {genConvert, opInfo(wa.I64) | (opInfo(wa.F32) << 8) | (opInfo(prop.TruncU) << 16)},
	OpcodeI64TruncSF64:      {genConvert, opInfo(wa.I64) | (opInfo(wa.F64) << 8) | (opInfo(prop.TruncS) << 16)},
	OpcodeI64TruncUF64:      {genConvert, opInfo(wa.I64) | (opInfo(wa.F64) << 8) | (opInfo(prop.TruncU) << 16)},
	OpcodeF32ConvertSI32:    {genConvert, opInfo(wa.F32) | (opInfo(wa.I32) << 8) | (opInfo(prop.ConvertS) << 16)},
	OpcodeF32ConvertUI32:    {genConvert, opInfo(wa.F32) | (opInfo(wa.I32) << 8) | (opInfo(prop.ConvertU) << 16)},
	OpcodeF32ConvertSI64:    {genConvert, opInfo(wa.F32) | (opInfo(wa.I64) << 8) | (opInfo(prop.ConvertS) << 16)},
	OpcodeF32ConvertUI64:    {genConvert, opInfo(wa.F32) | (opInfo(wa.I64) << 8) | (opInfo(prop.ConvertU) << 16)},
	OpcodeF32DemoteF64:      {genConvert, opInfo(wa.F32) | (opInfo(wa.F64) << 8) | (opInfo(prop.Demote) << 16)},
	OpcodeF64ConvertSI32:    {genConvert, opInfo(wa.F64) | (opInfo(wa.I32) << 8) | (opInfo(prop.ConvertS) << 16)},
	OpcodeF64ConvertUI32:    {genConvert, opInfo(wa.F64) | (opInfo(wa.I32) << 8) | (opInfo(prop.ConvertU) << 16)},
	OpcodeF64ConvertSI64:    {genConvert, opInfo(wa.F64) | (opInfo(wa.I64) << 8) | (opInfo(prop.ConvertS) << 16)},
	OpcodeF64ConvertUI64:    {genConvert, opInfo(wa.F64) | (opInfo(wa.I64) << 8) | (opInfo(prop.ConvertU) << 16)},
	OpcodeF64PromoteF32:     {genConvert, opInfo(wa.F64) | (opInfo(wa.F32) << 8) | (opInfo(prop.Promote) << 16)},
	OpcodeI32ReinterpretF32: {genConvert, opInfo(wa.I32) | (opInfo(wa.F32) << 8) | (opInfo(prop.Reinterpret) << 16)},
	OpcodeI64ReinterpretF64: {genConvert, opInfo(wa.I64) | (opInfo(wa.F64) << 8) | (opInfo(prop.Reinterpret) << 16)},
	OpcodeF32ReinterpretI32: {genConvert, opInfo(wa.F32) | (opInfo(wa.I32) << 8) | (opInfo(prop.Reinterpret) << 16)},
	OpcodeF64ReinterpretI64: {genConvert, opInfo(wa.F64) | (opInfo(wa.I64) << 8) | (opInfo(prop.Reinterpret) << 16)},
	0xc0:                    {badGen, 0},
	0xc1:                    {badGen, 0},
	0xc2:                    {badGen, 0},
	0xc3:                    {badGen, 0},

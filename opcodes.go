...
var opcodeImpls = [256]opImpl{
	...
	opcodeF32Copysign:       {genBinaryOp, opInfo(types.F32) | (opInfo(opers.FloatCopysign) << 16)},
	...
	opcodeF64Copysign:       {genBinaryOp, opInfo(types.F64) | (opInfo(opers.FloatCopysign) << 16)},

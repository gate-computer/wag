...
EXPORT void spectest_print(void) {}

EXPORT void spectest_print_f32(float v)
{
...
EXPORT void spectest_print_f64(double v)
{
...
EXPORT void spectest_print_f64_f64(double v1, double v2)
{
...
EXPORT void spectest_print_i32(uint32_t v)
{
...
EXPORT void spectest_print_i32_f32(uint32_t v1, float v2)
{
...
EXPORT uint32_t test_func_i32_to_i32(uint32_t v) { return v; }
EXPORT uint64_t test_func_i64_to_i64(uint64_t v) { return v; }
EXPORT float test_func_to_f32(void) { return 0; }
EXPORT uint32_t test_func_to_i32(void) { return 0; }
